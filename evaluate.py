...
tf.flags.DEFINE_string("checkpoint_dir", "./runs/NB/1554088006", "Checkpoint directory from training run")
...
# Evaluation
# ==================================================
checkpoint_file = './runs/NB/1554088006/checkpoints/model-350'
graph = tf.Graph()
